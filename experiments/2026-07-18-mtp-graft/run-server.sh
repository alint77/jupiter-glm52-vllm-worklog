...
export TIERED_MOE_MODEL_PATH="${TIERED_MOE_MODEL_PATH-$(dirname -- "${repo_dir}")/models/GLM-5.2-W4A16-FP8-MTP}"
...
export TIERED_MOE_COMPILATION_CONFIG='{"mode":3,"cudagraph_mode":"FULL_AND_PIECEWISE","cudagraph_capture_sizes":[4],"compile_sizes":[4],"pass_config":{"fuse_allreduce_rms":false}}'
