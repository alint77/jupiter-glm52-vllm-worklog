...
#SBATCH --output=agent_space/experiments/2026-07-25-tier-order/slurm-%x-%j.out
#SBATCH --error=agent_space/experiments/2026-07-25-tier-order/slurm-%x-%j.err
...
result_dir="${repo_dir}/agent_space/experiments/2026-07-25-tier-order"
...
agent_space/experiments/2026-07-25-tier-order/run-benchmark.sh \
  "${label}"
