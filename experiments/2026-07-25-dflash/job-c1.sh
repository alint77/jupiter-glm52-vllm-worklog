...
#SBATCH --output=agent_space/experiments/2026-07-25-dflash/slurm-%x-%j.out
#SBATCH --error=agent_space/experiments/2026-07-25-dflash/slurm-%x-%j.err
...
result_dir="${repo_dir}/agent_space/experiments/2026-07-25-dflash"
...
agent_space/experiments/2026-07-25-dflash/run-server-dflash.sh \
  "${spec_tokens}" 1 "" \
...
agent_space/experiments/2026-07-25-dflash/run-benchmark-c1.sh "${label}"
