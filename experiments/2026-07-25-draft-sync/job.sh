...
#SBATCH --output=agent_space/experiments/2026-07-25-draft-sync/slurm-%x-%j.out
#SBATCH --error=agent_space/experiments/2026-07-25-draft-sync/slurm-%x-%j.err
...
result_dir="${repo_dir}/agent_space/experiments/2026-07-25-draft-sync"
...
agent_space/experiments/2026-07-25-draft-sync/run-benchmark.sh \
  "${label}"
